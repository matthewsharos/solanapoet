// Test script to debug environment variables on Vercel deployment
...
function debugEnvironment() {
  return new Promise((resolve, reject) => {
    console.log(`Checking environment variables at ${VERCEL_URL}/api/sheets/debug-env`);
    
    const options = {
      hostname: 'solanapoet.vercel.app',
      path: '/api/sheets/debug-env',
      method: 'GET',
      headers: {
      ...
      res.on('end', () => {
        ...
        try {
          ...
          if (res.statusCode >= 200 && res.statusCode < 300) {
            console.log('SUCCESS: Environment debug check succeeded!');
